...
mutableResources["en-US"].translation.routines = {
  ...
  editor: {
    ...
    customCronHint: "Five-field cron format. Example: 0 9 * * 1 = every Monday at 09:00.",
...
mutableResources["pt-BR"].translation.routines = {
  ...
  editor: {
    ...
    customCronHint: "Formato cron de cinco campos. Exemplo: 0 9 * * 1 = toda segunda às 09:00.",
...
mutableResources["es-ES"].translation.routines = {
  ...
  editor: {
    ...
    customCronHint: "Cron de cinco campos. Ejemplo: 0 9 * * 1 = cada lunes a las 09:00.",
...
mutableResources["fr-FR"].translation.routines = {
  ...
  editor: {
    ...
    customCronHint: "Cron à cinq champs. Exemple : 0 9 * * 1 = chaque lundi à 09:00.",
...
mutableResources["de-DE"].translation.routines = {
  ...
  editor: {
    ...
    customCronHint: "Cron mit fünf Feldern. Beispiel: 0 9 * * 1 = jeden Montag um 09:00.",
