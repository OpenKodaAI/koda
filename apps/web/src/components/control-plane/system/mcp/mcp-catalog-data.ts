...
export const MCP_SUGGESTED_SERVERS: McpSuggestedServer[] = [
  // --- Obrigatórias (5) ---
  {
    ...
    description: "Conecte ao Supabase para executar queries SQL, gerenciar tabelas, listar funções e inspecionar a configuração do projeto diretamente pela conversa.",
  ...
  },
  {
    ...
    description: "Gerencie clientes, cobranças, assinaturas e reembolsos no Stripe. Crie payment links, inspecione invoices e consulte a documentação da API diretamente.",
    transport_type: "stdio",
    command_template: ["npx", "-y", PINNED_STRIPE_MCP_PACKAGE],
    env_fields: [
      { key: "STRIPE_SECRET_KEY", label: "Secret API Key", required: true },
    ],
    category: "data",
    logo_key: "stripe",
  ...
  },
  {
    ...
    description: "Crie e edite diagramas, fluxogramas e wireframes no Excalidraw. Exporte como imagem, manipule elementos e gerencie cenas de forma programática.",
    transport_type: "stdio",
  ...
  },
  {
    ...
    description: "Gerencie deployments, consulte logs de build e runtime, verifique domínios e monitore o status dos projetos na Vercel.",
    transport_type: "stdio",
  ...
  },
  {
    ...
    tagline: "Meeting notes e transcrições de reuniões",
    description: "Acesse notas de reuniões, transcrições e eventos de calendário capturados pelo Granola. Busque por conteúdo e recupere documentos específicos.",
    transport_type: "stdio",
  ...
  // --- Recomendadas (6) ---
  {
    ...
    description: "Investigue erros em produção, analise stack traces, busque issues e monitore a saúde dos projetos com integração direta ao Sentry.",
    transport_type: "stdio",
  ...
  },
  {
    ...
    description: "Gerencie issues, projetos e ciclos no Linear. Crie tickets, atualize status, adicione comentários e acompanhe o progresso das equipes.",
    transport_type: "stdio",
    command_template: ["npx", "-y", "@modelcontextprotocol/server-linear"],
    env_fields: [
      { key: "LINEAR_API_KEY", label: "Personal API Key", required: true },
    ],
    category: "productivity",
    logo_key: "linear",
    ...
    expected_tools: [
      ...
      { name: "get_my_issues", description: "Issues atribuídas a mim", read_only_hint: true },
  ...
  },
  {
    ...
    description: "Realize buscas na web, notícias, imagens e vídeos usando a API do Brave Search com foco em privacidade e resultados de alta qualidade.",
    transport_type: "stdio",
    ...
    expected_tools: [
      { name: "web_search", description: "Busca geral na web", read_only_hint: true },
      { name: "local_search", description: "Busca de negócios locais", read_only_hint: true },
    ],
  },
  {
    server_key: "slack",
    ...
    description: "Envie mensagens, leia histórico de canais, responda em threads e consulte perfis de usuários no Slack do seu workspace.",
    transport_type: "stdio",
  ...
  },
  {
    server_key: "notion",
    display_name: "Notion",
    tagline: "Páginas, databases e knowledge base",
    description: "Busque, crie e edite páginas e databases no Notion. Consulte conteúdo, adicione blocos e gerencie sua base de conhecimento pela conversa.",
    transport_type: "stdio",
    command_template: ["npx", "-y", "@notionhq/notion-mcp-server"],
    env_fields: [
      { key: "NOTION_TOKEN", label: "Notion Integration Token", required: true },
    ],
    category: "productivity",
    logo_key: "notion",
    ...
    expected_tools: [
      ...
      { name: "query_database", description: "Consultar database do Notion", read_only_hint: true },
      ...
      { name: "get_database", description: "Schema de um database", read_only_hint: true },
  ...
  },
  {
    ...
    description: "Gerencie zonas DNS, deploy de Workers, configure regras de firewall e monitore a infraestrutura Cloudflare dos seus domínios.",
    transport_type: "stdio",
  ...
  // --- Tier 1: Alto impacto ---
  {
    ...
    description: "Consulte a documentação do Google Maps Platform e gere código integrado com Maps, Places, Directions e Geocoding diretamente pela conversa.",
    transport_type: "stdio",
    ...
    expected_tools: [
      { name: "retrieve-google-maps-platform-docs", description: "Consultar documentação oficial do Google Maps", read_only_hint: true },
      { name: "codeGenerationAssist", description: "Gerar código integrado com Google Maps", read_only_hint: true },
    ],
  },
  {
    server_key: "todoist",
    ...
    description: "Gerencie tarefas, projetos, seções e labels no Todoist. Crie, complete, reabra e organize tarefas diretamente pela conversa.",
    transport_type: "stdio",
  ...
  },
  {
    ...
    description: "Acesse, busque e edite notas do seu vault Obsidian. Leia frontmatter, liste tags e pesquise conteúdo em toda a base de conhecimento.",
    transport_type: "stdio",
    command_template: ["npx", "-y", "@mauricio.wolff/mcp-obsidian", "/path/to/vault"],
    env_fields: [],
    category: "productivity",
    logo_key: "obsidian",
  ...
  },
  {
    ...
    description: "Execute queries, gerencie coleções e índices no MongoDB. Suporta MongoDB Atlas para provisionamento de clusters e gerenciamento de usuários.",
    transport_type: "stdio",
  ...
  // --- Tier 2: Alto impacto, verticals ---
  {
    server_key: "hubspot",
    display_name: "HubSpot",
    tagline: "CRM, contatos, deals e tickets",
    description: "Acesse e gerencie contatos, empresas, deals, tickets e faturas no HubSpot. Consulte dados do CRM diretamente pela conversa.",
    transport_type: "stdio",
    command_template: ["npx", "-y", "@hubspot/mcp-server"],
    env_fields: [
      { key: "PRIVATE_APP_ACCESS_TOKEN", label: "Private App Access Token", required: true },
    ],
    category: "cloud",
    logo_key: "hubspot",
  ...
  },
  {
    ...
    description: "Acesse arquivos de design, inspecione componentes, extraia design tokens e exporte assets do Figma para facilitar a implementação.",
    transport_type: "stdio",
    command_template: ["npx", "-y", "figma-developer-mcp", "--stdio"],
    env_fields: [
      { key: "FIGMA_API_KEY", label: "Figma Personal Access Token", required: true },
    ],
    category: "development",
    logo_key: "figma",
  ...
  },
  {
    ...
    description: "Envie SMS, faça chamadas de voz e gerencie recursos de comunicação do Twilio incluindo messaging, chat e funções serverless.",
    transport_type: "stdio",
  ...
  },
  {
    ...
    description: "Conecte a qualquer banco PostgreSQL externo para executar queries read-only e inspecionar schema via protocolo MCP.",
    transport_type: "stdio",
    ...
    expected_tools: [
      { name: "queryDatabase", description: "Executar queries SQL read-only", read_only_hint: true },
