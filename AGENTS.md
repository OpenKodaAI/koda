...
Use this file as the operational starting point for Codex and other `AGENTS.md`-aware tooling working in this repository. The matching [`CLAUDE.md`](CLAUDE.md) file mirrors the same repository guidance for Claude Code.
...
- [`CLAUDE.md`](CLAUDE.md) and the matching subtree `CLAUDE.md` files mirror this guidance for Claude Code.
...
- When you change repository guidance, keep the matching `AGENTS.md` and `CLAUDE.md` entrypoints aligned.
