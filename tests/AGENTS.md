...
The test suite mirrors the application structure and is the safety net for behavior changes. The matching [`CLAUDE.md`](CLAUDE.md) file mirrors the same local rules for Claude Code.
