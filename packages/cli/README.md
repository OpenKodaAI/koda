...
<div align="center" style="display: flex; align-items: center; justify-content: center; margin-bottom: 10px; width: 100%;">
  <img src="https://raw.githubusercontent.com/OpenKodaAI/koda/v1.0.8/docs/assets/brand/koda_hero.jpeg" alt="Koda" style="border-radius: 0.5rem;" width="450px" />
</div>
...
<p align="center">
  <a href="https://github.com/OpenKodaAI/koda/blob/v1.0.8/docs/install/local.md"><img alt="Quickstart" src="https://img.shields.io/badge/Quickstart-Docker--first-0F766E?style=for-the-badge" /></a>
  <a href="https://github.com/OpenKodaAI/koda/blob/v1.0.8/docs/README.md"><img alt="Documentation" src="https://img.shields.io/badge/Documentation-GitHub--native-162126?style=for-the-badge" /></a>
  <a href="https://github.com/OpenKodaAI/koda/blob/v1.0.8/docs/reference/api.md"><img alt="API Reference" src="https://img.shields.io/badge/API-OpenAPI-0B84D8?style=for-the-badge" /></a>
  <a href="https://github.com/OpenKodaAI/koda/blob/v1.0.8/docs/architecture/overview.md"><img alt="Architecture" src="https://img.shields.io/badge/Architecture-Control%20Plane%20%2B%20Web%20%2B%20Runtime-5C6B73?style=for-the-badge" /></a>
</p>

<p align="center">
  <a href="https://github.com/OpenKodaAI/koda/blob/v1.0.8/docs/install/local.md"><img alt="Postgres" src="https://img.shields.io/badge/Postgres-Durable%20state-336791?style=flat-square" /></a>
  <a href="https://github.com/OpenKodaAI/koda/blob/v1.0.8/docs/install/local.md"><img alt="SeaweedFS" src="https://img.shields.io/badge/SeaweedFS-S3--compatible%20storage-0F766E?style=flat-square" /></a>
  <a href="https://github.com/OpenKodaAI/koda/blob/v1.0.8/docs/reference/api.md"><img alt="Control Plane" src="https://img.shields.io/badge/Control%20Plane-Public%20HTTP%20surface-111827?style=flat-square" /></a>
  <a href="https://github.com/OpenKodaAI/koda/blob/v1.0.8/docs/architecture/runtime.md"><img alt="Runtime" src="https://img.shields.io/badge/Runtime-Inspectable%20execution-374151?style=flat-square" /></a>
</p>

<p align="center">
  <a href="https://github.com/OpenKodaAI/koda/blob/v1.0.8/docs/install/local.md"><strong>Install locally</strong></a>
  ·
  <a href="https://github.com/OpenKodaAI/koda/blob/v1.0.8/docs/install/vps.md"><strong>Deploy on a VPS</strong></a>
  ·
  <a href="https://github.com/OpenKodaAI/koda/blob/v1.0.8/docs/config/reference.md"><strong>Configuration reference</strong></a>
  ·
  <a href="https://github.com/OpenKodaAI/koda/blob/v1.0.8/docs/openapi/control-plane.json"><strong>OpenAPI</strong></a>
</p>
...
<p align="center">
  <img src="https://raw.githubusercontent.com/OpenKodaAI/koda/v1.0.8/docs/assets/screenshots/setup.png" alt="Koda control plane interface" width="82%" />
</p>
...
For a public architecture walkthrough, start with [Documentation Index](https://github.com/OpenKodaAI/koda/blob/v1.0.8/docs/README.md), [Architecture Overview](https://github.com/OpenKodaAI/koda/blob/v1.0.8/docs/architecture/overview.md), and [Runtime Architecture](https://github.com/OpenKodaAI/koda/blob/v1.0.8/docs/architecture/runtime.md).

## Installation Paths

- [Local install](https://github.com/OpenKodaAI/koda/blob/v1.0.8/docs/install/local.md)
- [VPS install](https://github.com/OpenKodaAI/koda/blob/v1.0.8/docs/install/vps.md)
- [Object storage migration](https://github.com/OpenKodaAI/koda/blob/v1.0.8/docs/install/object-storage-migration.md)
- [Configuration reference](https://github.com/OpenKodaAI/koda/blob/v1.0.8/docs/config/reference.md)
- [Release distribution](https://github.com/OpenKodaAI/koda/blob/v1.0.8/docs/reference/releases.md)
...
- [`docs/openapi/control-plane.json`](https://github.com/OpenKodaAI/koda/blob/v1.0.8/docs/openapi/control-plane.json) as the maintained public API contract
- [API reference](https://github.com/OpenKodaAI/koda/blob/v1.0.8/docs/reference/api.md) for an operator-facing summary of the HTTP surface
...
- [Documentation index](https://github.com/OpenKodaAI/koda/blob/v1.0.8/docs/README.md)
- [Architecture overview](https://github.com/OpenKodaAI/koda/blob/v1.0.8/docs/architecture/overview.md)
- [Runtime architecture](https://github.com/OpenKodaAI/koda/blob/v1.0.8/docs/architecture/runtime.md)
- [Security readiness](https://github.com/OpenKodaAI/koda/blob/v1.0.8/docs/security/README.md)
- [API reference](https://github.com/OpenKodaAI/koda/blob/v1.0.8/docs/reference/api.md)
- [Local install](https://github.com/OpenKodaAI/koda/blob/v1.0.8/docs/install/local.md)
- [VPS install](https://github.com/OpenKodaAI/koda/blob/v1.0.8/docs/install/vps.md)
- [Configuration reference](https://github.com/OpenKodaAI/koda/blob/v1.0.8/docs/config/reference.md)
- [Contributing](https://github.com/OpenKodaAI/koda/blob/v1.0.8/CONTRIBUTING.md)
- [Security policy](https://github.com/OpenKodaAI/koda/blob/v1.0.8/SECURITY.md)
- [Code of conduct](https://github.com/OpenKodaAI/koda/blob/v1.0.8/CODE_OF_CONDUCT.md)

## Contributing, Security, And Licensing

Contributors should start with [CONTRIBUTING.md](https://github.com/OpenKodaAI/koda/blob/v1.0.8/CONTRIBUTING.md) for local setup, validation, and documentation expectations. Security-sensitive reporting guidance lives in [SECURITY.md](https://github.com/OpenKodaAI/koda/blob/v1.0.8/SECURITY.md), and community participation expectations live in [CODE_OF_CONDUCT.md](https://github.com/OpenKodaAI/koda/blob/v1.0.8/CODE_OF_CONDUCT.md).

For the application-security baseline, threat model, ASVS mapping, and operational hardening checklist, use [docs/security/README.md](https://github.com/OpenKodaAI/koda/blob/v1.0.8/docs/security/README.md).

Koda is published under the Apache-2.0 license.

## Developer And AI-Friendly Entry Points

- [AGENTS.md](https://github.com/OpenKodaAI/koda/blob/v1.0.8/AGENTS.md)
- [CLAUDE.md](https://github.com/OpenKodaAI/koda/blob/v1.0.8/CLAUDE.md)
- [docs/ai/repo-map.yaml](https://github.com/OpenKodaAI/koda/blob/v1.0.8/docs/ai/repo-map.yaml)
- [docs/ai/llm-compatibility.md](https://github.com/OpenKodaAI/koda/blob/v1.0.8/docs/ai/llm-compatibility.md)
- [docs/ai/architecture-overview.md](https://github.com/OpenKodaAI/koda/blob/v1.0.8/docs/ai/architecture-overview.md)
- [docs/ai/runtime-flows.md](https://github.com/OpenKodaAI/koda/blob/v1.0.8/docs/ai/runtime-flows.md)
- [docs/ai/configuration-and-prompts.md](https://github.com/OpenKodaAI/koda/blob/v1.0.8/docs/ai/configuration-and-prompts.md)
...
Coverage thresholds are sourced from [pyproject.toml](https://github.com/OpenKodaAI/koda/blob/v1.0.8/pyproject.toml), not duplicated in workflow files. GitHub uploads `pytest`/coverage artifacts, `vitest` results, and SARIF findings so failures can be reviewed directly in artifacts or in the Security tab.
...
contract and artifact flow, see [Release distribution](https://github.com/OpenKodaAI/koda/blob/v1.0.8/docs/reference/releases.md).
