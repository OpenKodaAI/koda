...
<p align="center">
  <a href="https://github.com/OpenKodaAI/koda/blob/v1.0.10/docs/install/local.md">Quickstart</a>
  ·
  <a href="https://github.com/OpenKodaAI/koda/blob/v1.0.10/docs/README.md">Docs</a>
  ·
  <a href="https://github.com/OpenKodaAI/koda/blob/v1.0.10/docs/reference/api.md">API</a>
  ·
  <a href="https://github.com/OpenKodaAI/koda/blob/v1.0.10/docs/architecture/overview.md">Architecture</a>
</p>
...
<p align="center">
  <img src="https://raw.githubusercontent.com/OpenKodaAI/koda/v1.0.10/docs/assets/screenshots/overview.png" alt="Koda dashboard overview" width="32%" />
  <img src="https://raw.githubusercontent.com/OpenKodaAI/koda/v1.0.10/docs/assets/screenshots/costs.png" alt="Koda costs dashboard" width="32%" />
  <img src="https://raw.githubusercontent.com/OpenKodaAI/koda/v1.0.10/docs/assets/screenshots/runtime.png" alt="Koda runtime dashboard" width="32%" />
</p>
...
- [`docs/openapi/control-plane.json`](https://github.com/OpenKodaAI/koda/blob/v1.0.10/docs/openapi/control-plane.json) maintained OpenAPI contract
...
- [Operations runbooks](https://github.com/OpenKodaAI/koda/blob/v1.0.10/docs/operations/README.md)
