...
<div align="center" style="display: flex; align-items: center; justify-content: center; margin-bottom: 10px; width: 100%;">
  <img src="https://raw.githubusercontent.com/OpenKodaAI/koda/v1.0.10/docs/assets/brand/koda_hero.jpg" alt="Koda" width="100%" />
</div>
...
- [CLAUDE.md](https://github.com/OpenKodaAI/koda/blob/v1.0.10/CLAUDE.md) — operational guide for coding agents working in this repository
- [docs/architecture/overview.md](https://github.com/OpenKodaAI/koda/blob/v1.0.10/docs/architecture/overview.md) — platform architecture
- [docs/install/local.md](https://github.com/OpenKodaAI/koda/blob/v1.0.10/docs/install/local.md) — local install walkthrough
- [docs/reference/api.md](https://github.com/OpenKodaAI/koda/blob/v1.0.10/docs/reference/api.md) — API reference
