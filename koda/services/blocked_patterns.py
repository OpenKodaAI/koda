...
from koda.config import BLOCKED_DOCKER_PATTERN, BLOCKED_NPM_PATTERN, BLOCKED_PIP_PATTERN, BLOCKED_SHELL_PATTERN
...
# Module-level guards. ``None`` when the source pattern was env-disabled.
