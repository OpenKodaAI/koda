...
This package contains the application runtime. Read this guide before editing anything under `koda`. The matching [`CLAUDE.md`](CLAUDE.md) file mirrors the same local rules for Claude Code.
