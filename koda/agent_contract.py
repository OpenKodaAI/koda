...
_CORE_PROVIDER_DEFINITIONS: tuple[CoreProviderDefinition, ...] = (
    ...
    CoreProviderDefinition(
        ...
        description=(
            "Modelos Sonar com pesquisa em tempo real e citações de fontes via API key. "
            "Acesso programático via console em perplexity.ai/settings/api."
        ),
        category="general",
        supports_streaming=True,
        supports_native_resume=False,
    ...
    CoreProviderDefinition(
        ...
        runtime_adapter="openai_compatible",
        description=(
            "Família Mistral (Large, Medium, Small, Codestral, Pixtral) via La Plateforme API key. "
            "Visão via Pixtral, código via Codestral."
        ),
        category="general",
        supports_streaming=True,
        supports_native_resume=False,
    ...
    CoreProviderDefinition(
        ...
        runtime_adapter="openai_compatible",
        description=(
            "Família Qwen via Alibaba DashScope International. Inclui Qwen3-Coder, Qwen-VL "
            "e contexto longo de até 1M tokens."
        ),
        category="general",
        supports_streaming=True,
        supports_native_resume=False,
    ...
    CoreProviderDefinition(
        ...
        vendor="Moonshot AI",
        runtime_adapter="openai_compatible",
        description=("Modelos Kimi K2 e Moonshot v1 com janela de contexto até 128K tokens. Visão via kimi-vision."),
        category="general",
        supports_streaming=True,
        supports_native_resume=False,
        supports_tool_loop=True,
    ...
    CoreProviderDefinition(
        ...
        runtime_adapter="openai_compatible",
        description=(
            "Inferência ultra-rápida via LPU para Llama 3.3, Mixtral, Gemma2, DeepSeek-R1 distill e Qwen 2.5."
        ),
        category="general",
        supports_streaming=True,
        supports_native_resume=False,
    ...
    CoreProviderDefinition(
        ...
        runtime_adapter="openai_compatible",
        description=(
            "DeepSeek V3 (chat) e R1 (reasoner) com prompt caching automático e custo significativamente menor."
        ),
        category="general",
        supports_streaming=True,
        supports_native_resume=False,
