...
def image_refs(version: str) -> dict[str, str]:
    return {
        ...
        "artifact": f"{GHCR_NAMESPACE}/koda-artifact:{version}",
        "retrieval": f"{GHCR_NAMESPACE}/koda-retrieval:{version}",
        "runtime_kernel": f"{GHCR_NAMESPACE}/koda-runtime-kernel:{version}",
